...
$p = 8$ porque o overhead de comunicação (\texttt{MPI\_Reduce})
...
\midrule
64 & $4.91 \times 10^{-2}$ & $4.02 \times 10^{-4}$ & -3.39 \\
256 & $1.23 \times 10^{-2}$ & $2.51 \times 10^{-5}$ & -4.60 \\
1024 & $3.07 \times 10^{-3}$ & $1.57 \times 10^{-6}$ & -5.80 \\
4096 & $7.67 \times 10^{-4}$ & $9.80 \times 10^{-8}$ & -7.00 \\
16384 & $1.92 \times 10^{-4}$ & $6.13 \times 10^{-9}$ & -8.21 \\
\bottomrule
\end{tabular}
...
A figura~\ref{fig:convergencia} apresenta o gráfico log-log do erro absoluto em
função de $h$. A inclinação medida da reta de regressão linear nos pontos é de $2.00$, o que
confirma empiricamente que a convergência da regra do trapézio é de fato $O(h^2)$.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{convergencia.pdf}
    \caption{Gráfico log-log de convergência da regra do trapézio (escala log-log).}
